...
## "makeCacheMatrix" takes a square matrix as argument. It will return a
## list that includes the functions to access and change both the original 
...
## "cacheSolve" takes the result of "makeCacheMatrix", a list of functions, 
...
## cachedRandomMatrix <- makeCacheMatrix(randomMatrix)
